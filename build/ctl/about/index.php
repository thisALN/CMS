...
<head>
	...
	<style type="text/css">
		img, iframe {max-width: 100%; max-height: 85vh;}
	</style>
</head>
<body>
	<a href="images/CMS.pdf">A pdf</a><a href="/">Home</a><a href="/ctl/">Admin</a>
	<iframe src="images/CMS.pdf" width="400" height="700" style="float: right;"></iframe>
	...
	<p><img src="images/IMG_0163.JPG" style="float: right;"/>Normally a webserver only returns the relevant file at the location you ask for (from the url) and if you only specify a directory it only returns the "index.TYPE" file unless other rules are set. That's why some urls are</p>
	<blockquote>
	<pre>
